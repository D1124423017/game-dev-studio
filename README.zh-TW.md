...
- 省 token 模式：Quick Check、Focused Review、Full Studio Audit、Roadmap Strategy Audit，讓日常任務保持輕量
...
三個公開專案案例請看 [examples/](examples/)，測試紀錄請看 [validation/test-results-v0.5.0.md](validation/test-results-v0.5.0.md)。
...
- 新增 Roadmap Strategy Audit，用於成熟度與下一版本決策
- 新增 Phaser、Godot、Unity 公開專案實證案例
- 執行並記錄十組 Skill prompt 測試
- 新增零相依驗證工具與 GitHub Actions workflow
- 修正 CHANGELOG 與 release 歷史一致性
